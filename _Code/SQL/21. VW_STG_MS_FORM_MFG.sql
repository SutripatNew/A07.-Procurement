...
/****** Object:  View [dbo].[VW_STG_MS_FORM_MFG]    Script Date: 20/5/2568 9:29:27 ******/
SET ANSI_NULLS ON
GO
...
(
	...
	ON A.formyear = D.[YEAR] AND LEFT(C.question_name,4) = D.QUESTION_CODE AND N'Manufacturing' = D.LEVEL1
