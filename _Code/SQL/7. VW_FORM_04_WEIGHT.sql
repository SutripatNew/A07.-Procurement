...
/****** Object:  View [dbo].[VW_FORM_04_WEIGHT]    Script Date: 19/5/2568 13:09:07 ******/
SET ANSI_NULLS ON
GO
...
THEN 
	...
	ELSE CAST(CAST(Q.WEIGHT AS DECIMAL(9,4)) / COUNT(Q.QUESTION_DISPLAY) OVER (PARTITION BY Q.FUNCTION_NAME, Q.GROUP_QUESTION,Q.YEAR) AS DECIMAL(9,4))   END
-- Non RM Weighting
ELSE 
CAST( 
