...
/****** Object:  View [dbo].[VW_STG_MS_FORM_INTERNAL]    Script Date: 21/8/2568 9:14:37 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [dbo].[VW_STG_MS_FORM_INTERNAL] AS 
...
--			WHERE QUESTION_NAME IN ('ปีที่ประเมิน','Submission Time','Responder Email','Level1','Level2','ผู้รับการประเมิน ALL','ข้อเสนอแนะเพื่อการปรับปรุงการให้บริการของ Strategic Team','Above1MB','รอบการประเมิน','BelowThreshold', 'Pur_Grp')
--		) AS F
--		PIVOT  
--		(  
--		MIN(RESPONSE) FOR QUESTION_NAME IN ([ปีที่ประเมิน],[Submission Time],[Responder Email],[Level1],[Level2],[ผู้รับการประเมิน ALL],[ข้อเสนอแนะเพื่อการปรับปรุงการให้บริการของ Strategic Team],[Above1MB],[รอบการประเมิน],[BelowThreshold], [Pur_Grp])
--		) AS P
--	) A 
--	LEFT JOIN (
--		SELECT SHAREPOINT_LIST,ITEM_ID,QUESTION_NAME,RESPONSE FROM STG_MS_FORM_INTERNAL
--		WHERE QUESTION_NAME NOT IN ('ปีที่ประเมิน','Submission Time','Responder Email','Level1','Level2','ผู้รับการประเมิน ALL','ข้อเสนอแนะเพื่อการปรับปรุงการให้บริการของ Strategic Team','ข้อเสนอแนะ เพื่อปรับปรุงการบริการของ Vendor','ปีที่ประเมิน','Above1MB','รอบการประเมิน','BelowThreshold', 'Pur_Grp')
--	) B
