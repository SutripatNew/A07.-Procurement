...
/****** Object:  View [dbo].[VW_STG_MS_FORM_RM]    Script Date: 18/2/2568 8:56:03 ******/
SET ANSI_NULLS ON
GO
...
(
	...
	(
		...
		WHERE QUESTION_NAME IN ('ปีประเมิน', 'ประเภทสินค้า', 'โรงงาน', 'Submission Time','Responder Email','Level1','Level2','ผู้รับการประเมิน ALL','ข้อเสนอแนะ และคำแนะนำเพิ่มเติม','Above1MB','รอบการประเมิน','BelowThreshold')
	) AS F
	PIVOT  
	(  
	...
	[ข้อเสนอแนะ และคำแนะนำเพิ่มเติม],[Above1MB],[รอบการประเมิน],[BelowThreshold])
	) AS P

) A 
LEFT JOIN (
	SELECT SHAREPOINT_LIST,ITEM_ID,QUESTION_NAME,RESPONSE FROM STG_MS_FORM_RM
	WHERE QUESTION_NAME NOT IN ('ปีประเมิน',  'ประเภทสินค้า', 'โรงงาน', 'Submission Time','Responder Email','Level1','Level2','ผู้รับการประเมิน ALL','ข้อเสนอแนะ และคำแนะนำเพิ่มเติม','Above1MB','รอบการประเมิน','BelowThreshold')
) B
